...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-2 border-bottom border-success">
        <h1 class="h3 mb-0 text-gray-800">Uang Retribusi Keluar</h1>
    ...
    <div class="alert alert-info alert-dismissible fade show" role="alert">
        <strong><i class="fa-brands fa-squarespace"></i></strong> Anda dapat melihat maupun memasukan data barang keluar disini. !
