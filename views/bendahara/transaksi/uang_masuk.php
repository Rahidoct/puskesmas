<?php hakAkses(['bendahara']); ?>
<!-- Begin Page Content -->
<div class="container-fluid">

    <!-- Page Heading -->
    <div class="d-sm-flex align-items-center justify-content-between mb-2 border-bottom border-success">
        <h1 class="h3 mb-0 text-gray-800">Uang Retribusi Diterima</h1>
        <h3 class="mb-0 text-black-50-400">
            <strong>
                <span id="hours"></span>
    ...
    <div class="alert alert-info alert-dismissible fade show" role="alert">
        <strong><i class="fa-brands fa-squarespace"></i></strong> Anda dapat melihat maupun memasukan data barang masuk disini. !
